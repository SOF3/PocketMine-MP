...
/**
 * Called when a form is returned
 */
class PlayerFormReceiveEvent extends PlayerFormEvent{
	private $shouldResend = false;
	...
	public function setShouldResend(bool $shouldResend){
